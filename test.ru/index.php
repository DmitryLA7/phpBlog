<?php
  require "includes/config.php"; /*Запрос настроек и доступа к БД*/
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="block">
              ...
              <div class="block__content">
                <div class="articles articles__horizontal">
                   ...
                   <?php 
                  $articles = mysqli_query($connection, "SELECT * FROM `articles` ORDER BY `id` DESC LIMIT 10");/*Запрос статей блога из БД*/
                  ...
                  <article class="article">
                    <div class="article__image" style="background-image: url(static/images/<?php echo $art['image']; ?>);"></div><!--Получение картинки по названию из БД-->
                    <div class="article__info">
                      ...
                      <div class="article__info__meta">
                        <?php 
                          ...
                          foreach ($categories as $cat) 
                          {
                            ...
                            {
                              $art_cat = $cat; /*Получение категории статьи с помощью id статьи в БД*/
                              break;
                            }
                          }
                        ?>
                      ...
                      <div class="article__info__preview"><?php echo mb_substr(strip_tags($art['text']), 0 , 100, "UTF-8") . '...'; ?></div><!--Получение текста статьи из БД в виде превью (обрезан текст)-->
                    </div>
                  </article>
                  <?php
                    }
